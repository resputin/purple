...
//==============================================================================
PurpleAudioProcessor::PurpleAudioProcessor()
{
}
...
//==============================================================================
const String PurpleAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

const String PurpleAudioProcessor::getInputChannelName (int channelIndex) const
{
    return String (channelIndex + 1);
}

const String PurpleAudioProcessor::getOutputChannelName (int channelIndex) const
{
    return String (channelIndex + 1);
}

bool PurpleAudioProcessor::isInputChannelStereoPair (int index) const
{
    return true;
}

bool PurpleAudioProcessor::isOutputChannelStereoPair (int index) const
{
    return true;
}

bool PurpleAudioProcessor::acceptsMidi() const
{
...
bool PurpleAudioProcessor::producesMidi() const
{
...
bool PurpleAudioProcessor::silenceInProducesSilenceOut() const
{
    return false;
}

double PurpleAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

//tells host the number of parameters
int PurpleAudioProcessor::getNumParameters()
{
    return 7;
}

//returns the name of a parameter to the host
const String PurpleAudioProcessor::getParameterName (int index)
{
    if(index == 0)
    {return "Gain One";}
    if(index == 1)
...
float PurpleAudioProcessor::getParameter (int index)
{
    if(index == 0)
    {return gain1;}
    if(index == 1)
...
const String PurpleAudioProcessor::getParameterText (int index)
{
    if(index == 0)
    {return String (gain1);}
    if(index == 1)
...
void PurpleAudioProcessor::setParameter (int index, float newValue)
{
    if(index == 0)
    {gain1 = newValue;}
    if(index == 1)
...
int PurpleAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
    // so this should be at least 1, even if you're not really implementing programs.
}

int PurpleAudioProcessor::getCurrentProgram()
{
    return 0;
}

void PurpleAudioProcessor::setCurrentProgram (int index)
{
}

const String PurpleAudioProcessor::getProgramName (int index)
{
    return String();
}

void PurpleAudioProcessor::changeProgramName (int index, const String& newName)
{
}

//==============================================================================
void PurpleAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    // Use this method as the place to do any pre-playback
    // initialisation that you need..
}

void PurpleAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

void PurpleAudioProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
    int32_t sampnum;
    float inputL;
    float inputR;
...
//==============================================================================
bool PurpleAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

AudioProcessorEditor* PurpleAudioProcessor::createEditor()
{
    return new PurpleAudioProcessorEditor (*this);
}

//==============================================================================
void PurpleAudioProcessor::getStateInformation (MemoryBlock& destData)
{
...
void PurpleAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new PurpleAudioProcessor();
}
